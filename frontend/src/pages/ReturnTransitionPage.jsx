...
const FULL_TEXT = 'Returning to Mission Base...';

export default function ReturnTransitionPage() {
    ...
    /* Navigate to home after typing + hold */
    useEffect(() => {
    ...
    return (
        <div className="transition-page return-transition">
            {/* Background glows */}
